  ...
  const pages = [
    ...
    },
    {
      ...
      seo: {
        ...
        description: "All-Star ($100) and MVP ($50) surprise collectible packages with clear guarantees.",
  ...
  const offers = [
    {
      ...
      sortOrder: 0,
      seo: {
        title: "All-Star Package — $100 | Sodapops",
        description: "Surprise collectible assortment for $100. Contents vary by event and sport.",
    ...
    },
    {
      ...
      sortOrder: 1,
      seo: {
        title: "MVP Package — $50 | Sodapops",
        description: "100+ card package with guaranteed autograph for $50. Contents vary by event and sport.",
...
async function seedProducts() {
  const products = [
    ...
    },
    {
      ...
      shortDescription: "The $100 All-Star surprise assortment — contents vary.",
...
async function seedFaqs() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "The $100 All-Star Package is a surprise assortment that may include card packs, graded cards, autographs, and event-specific collectibles. Contents vary and no specific items are guaranteed.",
      category: "Packages",
    ...
    },
    {
      ...
      answer: "The $50 MVP Package includes 100+ cards with a guaranteed minimum of one autograph. Additional contents may include figures, graded cards, and event-specific items but vary by promotion.",
      category: "Packages",
      relatedPageKey: "pricing",
      sortOrder: 1,
    },
