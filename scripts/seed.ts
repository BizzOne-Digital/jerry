  ...
  const pages = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          images: [img("all-star-emblem.svg", "All-Star package"), img("mvp-emblem.svg", "MVP package")],
        },
        {
          id: "trust",
          type: "trust",
      ...
      sections: [
        {
          ...
          image: img("all-star-emblem.svg", "All-Star package emblem"),
        },
        {
          id: "comparison",
        ...
        },
        {
          ...
          order: 3,
          images: [
            img("mvp-emblem.svg", "MVP package"),
        ...
        },
        {
          ...
          image: img("mvp-emblem.svg", "MVP emblem"),
        },
      ],
      seo: {
        ...
        ogImage: img("mvp-emblem.svg", "Pricing"),
      },
    },
    {
      key: "testimonials",
  ...
  const services = [
    {
      ...
      cardImage: img("card-back-holographic.svg", "Holographic card back"),
      iconAccent: "gold",
    ...
    },
    {
      ...
      cardImage: img("card-stack.svg", "Stack of collectible cards"),
      iconAccent: "blue",
    ...
    },
    {
      ...
      cardImage: img("foil-sweep.svg", "Holographic foil sweep"),
      iconAccent: "red",
    ...
    },
    {
      ...
      cardImage: img("autograph-motif.svg", "Autograph signature motif"),
      iconAccent: "gold",
    ...
    },
    {
      ...
      cardImage: img("memorabilia-helmet.svg", "Display helmet silhouette"),
      iconAccent: "blue",
    ...
    },
    {
      ...
      cardImage: img("ticket-texture.svg", "Vintage ticket texture"),
      iconAccent: "red",
  ...
  const offers = [
    {
      ...
      images: [
        img("all-star-emblem.svg", "All-Star package emblem"),
        img("card-stack.svg", "Card assortment"),
      ...
      seo: {
        ...
        ogImage: img("all-star-emblem.svg", "All-Star Package"),
      },
    },
    {
      name: "MVP Package",
      ...
      images: [
        img("mvp-emblem.svg", "MVP package emblem"),
      ...
      seo: {
        ...
        ogImage: img("mvp-emblem.svg", "MVP Package"),
      },
    },
  ];
  ...
  const products = [
    {
      ...
      images: [
        img("card-back-classic.svg", "Card front demo"),
        img("card-back-holographic.svg", "Card back demo"),
        img("grade-label.svg", "Condition label"),
        img("foil-sweep.svg", "Foil detail"),
        img("card-stack.svg", "In collection context"),
      ],
      featured: true,
      onSale: true,
    },
    {
      ...
      isAuthenticated: false,
      images: [
        img("card-back-holographic.svg", "Graded card demo"),
        img("grade-label.svg", "Grade label"),
        img("vault-panel.svg", "Slab presentation"),
        img("card-back-classic.svg", "Card detail"),
        img("collector-badge.svg", "Collector context"),
      ],
      featured: true,
    },
    {
      ...
      images: [
        img("autograph-motif.svg", "Signed photo demo"),
        img("grade-label.svg", "COA label"),
        img("vault-opens.svg", "Display context"),
        img("collector-badge.svg", "Authentication badge"),
        img("memorabilia-helmet.svg", "Memorabilia accent"),
      ],
      featured: true,
    },
    {
      ...
      isAuthenticated: false,
      images: [
        img("memorabilia-helmet.svg", "Mini helmet demo"),
        img("vault-panel.svg", "Display case"),
        img("stadium-lights.svg", "Stadium context"),
        img("trophy-silhouette.svg", "Showcase accent"),
        img("arena-hero-glow.svg", "Arena display"),
      ],
      featured: false,
    },
    {
      ...
      isAuthenticated: false,
      images: [
        img("memorabilia-bat.svg", "Bat demo"),
        img("grade-label.svg", "Condition tag"),
        img("vault-opens.svg", "Vault storage"),
        img("memorabilia-glove.svg", "Companion piece"),
        img("broadcast-wipe.svg", "Broadcast accent"),
      ],
      featured: true,
    },
    {
      ...
      images: [
        img("ticket-texture.svg", "Ticket texture"),
        img("ticket-stub.svg", "Ticket stub"),
        img("stadium-lights.svg", "Stadium view"),
        img("broadcast-wipe.svg", "Broadcast"),
        img("arena-hero-glow.svg", "Arena"),
      ],
      featured: false,
    },
    {
      ...
      isAuthenticated: false,
      images: [
        img("all-star-emblem.svg", "All-Star emblem"),
        img("card-stack.svg", "Card assortment"),
        img("foil-sweep.svg", "Foil pack"),
        img("autograph-motif.svg", "Possible autograph"),
        img("mvp-emblem.svg", "Upgrade option"),
      ],
      featured: true,
    },
    {
      ...
      isAuthenticated: false,
      images: [
        img("mvp-emblem.svg", "MVP emblem"),
        img("card-stack.svg", "100+ cards"),
        img("autograph-motif.svg", "Guaranteed autograph"),
        img("grade-label.svg", "Graded possibility"),
        img("trophy-silhouette.svg", "Bonus item"),
      ],
      featured: true,
    },
  ];
...
async function seedTestimonials() {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      avatar: img("mvp-emblem.svg", "Demo avatar"),
      featured: false,
      sortOrder: 3,
      isDemo: true,
    },
