  ...
  return (
    <section className="flex min-h-[60vh] items-center py-24">
      <Container className="max-w-xl text-center">
        <h1 className="font-display text-2xl text-arena-cream sm:text-3xl">Checkout unavailable</h1>
        <p className="mt-4 text-sm text-arena-muted sm:text-base">
          Checkout didn&apos;t load fully. You can try again or return to your cart.
        </p>
